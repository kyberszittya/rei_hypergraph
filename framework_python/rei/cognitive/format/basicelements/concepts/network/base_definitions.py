...
from rei.cognitive.format.basicelements.concepts.registry.base_definitions import \
...
from rei.cognitive.format.basicelements.concepts.network.taxonomy import \
    NetworkTaxonomy, NetworkRegistryItem
from rei.cognitive.format.basicelements.concepts.identification.base_definitions import \
    MetaIdentifiable
