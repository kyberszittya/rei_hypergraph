...
from cognitive.channels.channel_base_definitions import CognitiveChannelDendrite
...
from physics.geometry.basic_geometry import PolyhedronGeometry, EllipsoidGeometry, CylinderGeometry, \
    PrimitiveGeometry
